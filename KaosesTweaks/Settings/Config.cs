...
#pragma warning restore CS8620 // Argument cannot be used for parameter due to differences in the null ability of reference types.
      ...
      HintText = "{=KPS_Debug_001}Show Fleeing Debug")]
        ...
        [SettingPropertyBool("{=KT_BannerQuest_Complete}Complete Banner Quest", Order = 1, RequireRestart = true, IsToggle = false,
        ...
        [SettingPropertyBool("{=KT_skipTutorial}Skip Tutorial", Order = 2, RequireRestart = true, IsToggle = false,
        ...
        HintText = "{=KT_skipCCVideo_Desc}Disable the Character creation Intro Video."),
        SettingPropertyGroup("{=KT_General}General Tweaks")] //, GroupOrder = 1
        public bool DisableCharacterIntroVideo { get; set; } = true;
        ...
        */
        ...
        public override IEnumerable<ISettingsPreset> GetBuiltInPresets()
        {
            ...
            yield return new MemorySettingsPreset(Id, "Bannerlord Tweaks defaults 1.5.7.2", "Bannerlord Tweaks defaults 1.5.7.2", () => new Config
            {
